//
//  PublicFollowersViewController.swift
//  InTheGym
//
...
class PublicFollowersViewController: UIViewController {
    // coordinator
    weak var coordinator: UserProfileCoordinator?
    // display
    var childContentView: PublicFollowersFollowingView!
    // view model
    var viewModel = PublicFollowersViewModel()
    // subscriptions
...
// MARK: - Actions
private extension PublicFollowersViewController {
