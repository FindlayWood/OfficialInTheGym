//
//  TimelineCreatedWorkoutTableViewCell.swift
//  InTheGym
//
...
class TimelineCreatedWorkoutTableViewCell: UITableViewCell, CellConfiguarable {
    ...
    func setup(rowViewModel: PostProtocol) {
        let model = rowViewModel as! TimelineCreatedWorkoutModel
    ...
    static func cellIdentifier() -> String{
        return "TimelineCreatedWorkoutTableViewCell"
    }
