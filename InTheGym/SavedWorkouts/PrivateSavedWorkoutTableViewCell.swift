//
//  PrivateSavedWorkoutTableViewCell.swift
//  InTheGym
//
...
class PrivateSavedWorkoutTableViewCell: UITableViewCell {
    ...
    var workout : privateSavedWorkout! {
        didSet{
            self.title.text = workout.title
            self.createdBy.text = workout.createdBy
