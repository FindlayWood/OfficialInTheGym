...
class StaticMessages {
    ...
    static let emomTimeMessage = "EMOMs need a time limit. The limit is the time you want to be doing the exercises for. The initial time is set to 10 minutes, to change it tap on this section and select a new time."
