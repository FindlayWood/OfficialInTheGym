//
//  PracticeTrackerDetailView.swift
//  InTheGym
//
...
struct PracticeTrackerDetailView: View {
                ...
                HStack {
                    VStack(alignment: .leading) {
                        Text("Workload Data")
                            .font(.title.bold())
                            .foregroundColor(Color(.darkColour))
                        Text("This is data at the time of entering practice details")
                            .font(.footnote)
                            .foregroundColor(.secondary)
                    }
                    Spacer()
