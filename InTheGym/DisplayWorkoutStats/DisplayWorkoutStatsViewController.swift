...
class DisplayWorkoutStatsViewController: UIViewController {
    ...
    lazy var viewModel: DisplayWorkoutStatsViewModel = {
        return DisplayWorkoutStatsViewModel(workoutSavedID: savedWorkoutID, firebaseService: firebaseService)
    }()
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.navigationItem.title = "Workout Stats"
