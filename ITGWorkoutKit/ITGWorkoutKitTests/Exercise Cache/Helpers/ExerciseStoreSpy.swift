...
class ExerciseStoreSpy: ExerciseStore {
    enum ReceivedMessage: Equatable {
        ...
        case insert([LocalExerciseItem], Date)
        case retrieve
    }
    ...
    func completeRetrieval(with feed: [LocalExerciseItem], timestamp: Date, at index: Int = 0) {
        retrievalCompletions[index](.success(CachedExerciseList(list: feed, timestamp: timestamp)))
    }
}
