...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    private func resultFor(_ values: (data: Data?, response: URLResponse?, error: Error?)?, taskHandler: (HTTPClientTask) -> Void = { _ in }, file: StaticString = #file, line: UInt = #line) -> Client.Result {
        ...
        taskHandler(sut.get(from: anyURLString()) { result in
