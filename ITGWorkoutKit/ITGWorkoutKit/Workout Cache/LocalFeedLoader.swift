...
public final class LocalFeedLoader {
    ...
    public func save(_ items: [WorkoutItem], completion: @escaping (SaveResult) -> Void) {
    ...
    private func cache(_ items: [WorkoutItem], with completion: @escaping (SaveResult) -> Void) {
