...
final class WorkoutAPIEndToEndTests: XCTestCase {
    ...
    private func getFeedImageDataResult(file: StaticString = #file, line: UInt = #line) -> FeedImageDataLoader.Result? {
        let loader = RemoteFeedImageDataLoader(client: ephemeralHTTPClient())
        trackForMemoryLeaks(loader, file: file, line: line)
    ...
    private var feedTestServerString: String {
    ...
    private var feedTestServerURL: URL {
        URL(string: "https://static1.squarespace.com/static/5891c5b8d1758ec68ef5dbc2/t/5c52cdd0b8a045df091d2fff/1548930512083/feed-case-study-test-api-feed.json")!
    }
    ...
    private func ephemeralHTTPClient(file: StaticString = #file, line: UInt = #line) -> HTTPClient {
        let client = URLSessionHTTPClient2(session: URLSession(configuration: .ephemeral))
        trackForMemoryLeaks(client, file: file, line: line)
        return client
    }
