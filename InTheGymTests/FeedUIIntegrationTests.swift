...
class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_imageSelection_notifiesHandler() {
        ...
        var selectedImages = [WorkoutItem]()
    ...
    func test_feedImageView_loadsImageURLWhenVisible() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.image], "Expected first image URL request once first view becomes visible")

        sut.simulateFeedImageViewVisible(at: 1)
        XCTAssertEqual(loader.loadedImageURLs, [image0.image, image1.image], "Expected second image URL request once second view also becomes visible")
    }
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.image], "Expected one cancelled image URL request once first image is not visible anymore")

        sut.simulateFeedImageViewNotVisible(at: 1)
        XCTAssertEqual(loader.cancelledImageURLs, [image0.image, image1.image], "Expected two cancelled image URL requests once second image is also not visible anymore")
    }
    ...
    func test_feedImageView_reloadsImageURLWhenBecomingVisibleAgain() {
        ...
        XCTAssertEqual(loader.loadedImageURLs, [image0.image, image0.image], "Expected two image URL request after first view becomes visible again")

        sut.simulateFeedImageBecomingVisibleAgain(at: 1)

        XCTAssertEqual(loader.loadedImageURLs, [image0.image, image0.image, image1.image, image1.image], "Expected two new image URL request after second view becomes visible again")
    }
